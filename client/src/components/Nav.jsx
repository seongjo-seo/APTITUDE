			...
			<nav class="shadow-sm py-2 border-bottom">
				<div class="container d-flex flex-wrap">
						...
						<ul class="nav me-auto">
							...
							<ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
										<li><Link class="dropdown-item" to={"/"}>모든 상품 보기</Link></li>
							...
							<li class="nav-item"><Link class="nav-link link-dark px-2" to={"/"}>할인상품</Link></li>
							<li class="nav-item"><Link class="nav-link link-dark px-2" to={"/"}>판매자 등록 신청</Link></li>
							<li class="nav-item"><Link class="nav-link link-dark px-2" to={"/"}>공지사항</Link></li>
